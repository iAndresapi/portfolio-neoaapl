...
export function ProjectCard({ title, description, tags, image, demoUrl}: ProjectCardProps) {
        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="p-6 flex-grow">
            ...
            <div className="flex justify-between mt-auto pt-4 border-t border-zinc-700/50">
              <Button
                size="sm"
                className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-emerald-500 hover:to-green-500 border-0"
                asChild
              >
